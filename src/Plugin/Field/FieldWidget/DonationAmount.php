...
/**
 * Plugin implementation of the 'number' widget form the donation amount.
 *
 * @FieldWidget(
 *   id = "donation_amount",
 ...
 * )
 */
class DonationAmount extends NumberWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if($this->fieldDefinition->getType() !== 'donation_amount') {
