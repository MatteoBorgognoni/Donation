...
/**
 * Plugin implementation of the 'text_textarea_with_summary_token' widget.
 *
 * @FieldWidget(
 *   id = "text_textarea_with_summary_token",
 *   label = @Translation("Text area with a summary and tokens"),
 *   field_types = {
 *     "text_with_summary"
 *   }
 * )
 */
class TextareaWithSummaryToken extends TextareaWidget {
