...
/**
 * Plugin implementation of the 'Generic Address' formatter.
 *
 * @FieldFormatter(
 *   id = "generic_address",
 ...
 * )
 */
class GenericAddress extends FormatterBase {
  ...
  protected function viewValue(FieldItemInterface $item) {
    ...
    foreach ($values as $key => $value) {
      if (is_string($value) && !empty($value) && isset($addressfields[$key])) {
        $output = '<div class="field__label">' . $addressfields[$key]['title'] . '</div>';
